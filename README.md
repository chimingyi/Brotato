...
线上地址目前仍是稳定的 v1。v2 正在 `codex/gameplay-parity-v2` 分支开发，玩法系统清单已经全部实现：完整分波商店闭环、六武器构筑、12 名角色、24 把武器、80 件道具、16 种普通敌人、4 种精英、3 种首领、5 个危险等级、20 波，以及解锁、存档、图鉴、设置、引导和可破坏物。当前正在进行发布前平衡审计；通过前不会覆盖线上 v1。
