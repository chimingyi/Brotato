...
线上地址目前仍是稳定的 v1。v2 正在 `codex/gameplay-parity-v2` 分支开发，前四个里程碑已经完成：完整分波商店闭环、六武器构筑、12 名角色、24 把武器、80 件道具，以及 16 种普通敌人、4 种精英、3 种首领、5 个危险等级和完整 20 波。下一阶段将完成解锁、存档、图鉴、设置和发布验收。
